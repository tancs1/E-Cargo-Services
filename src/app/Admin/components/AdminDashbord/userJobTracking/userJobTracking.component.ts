...
@Component({
  selector: 'app-userJobTracking',
  templateUrl: './userJobTracking.component.html',
  styleUrls: ['./userJobTracking.component.css']
})
export class UserJobTrackingComponent implements OnInit {
